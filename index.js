/* JANGAN GANTI INFO!!! 
* HARGAILAH PEMBUAT SCRIPT
* BETAPA SUSAHNYA BUAT SCRIPT INI!! 
* BOLEH GANTI, KECUALI INFO!!! 
* PELO-STACK
* ALIF MAULANA P
* BOT X-PLAY
*/
...
const isUrl = new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/gi) 
       ...
       client.sendMessage(id, 'Nieh nomer Collab Author aku, chat ajah terus di save, nanti di back kok kak ><',MessageType.text)
        ...
        case '!demote':
            ...
            client.sendFileFromUrl(from, loli.result, 'loli.jpeg', 'Nih lolimu, jangan rusak dia om>///<', id)
            break
        case '!waifu':
        ...
        case '!quotesnime':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ BOT X-PLAY Broadcast ]\n\n${msg}`)
            }
